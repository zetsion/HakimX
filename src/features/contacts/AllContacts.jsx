...
export default function AllContacts() {
  return (
    <div className="container mx-auto mt-16 border-t-4 border-yellow-600 bg-teal-300 px-4 py-8">
      <h1 className="mb-6 text-center text-3xl font-bold">
        <TypingText text="Get in Touch" />
      </h1>

      <div className="flex flex-col justify-center md:flex-row md:space-x-8">
        <div className="mb-6 flex-1 rounded-lg border-x-4 border-yellow-600 bg-white p-6 shadow-lg md:mb-0">
